            ...
            <div className='container '>
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <div className='text-center flex flex-col items-center gap-3'>
                        <h3 className={`font-bold text-[36px] leading-[36px] tracking-wide ${inter.className}`}>How It <span className='text-primary'>Works</span></h3>
                ...
                <section className='flex items-center pt-7 '>
                    ...
                    <Image className='absolute left-[600px] ' src={"/logo/following.png"} width={247} height={112} alt='following process' />
                    ...
                    <Image className='absolute right-[600px]' src={"/logo/following2.png"} width={247} height={112} alt='following process' />
