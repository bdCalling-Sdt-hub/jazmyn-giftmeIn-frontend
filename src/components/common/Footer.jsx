...
>
      <div className="container h-[425px] content-center mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <Link href="/contact" className="flex items-center gap-3 text-sm">
            ...
            <li>
              <Link href="mailto:support@giftmein.com" className="flex items-center gap-3 text-sm">
                <div className="bg-primary p-2 rounded-full">
                  <Image
      ...
      <div className='container mx-auto px-7 flex justify-between items-center pt-8'>
        <h3 className='text-[16px] '>© Copyright 2025 <span className='text-primary text-[18px]'>Giftmein</span> All Rights Reserved.</h3>
        <div className='flex justify-center items-center gap-2'>
        <p className='text-[16px] leading-[39px] font-normal'>Follow Us:</p>
                  <Image
